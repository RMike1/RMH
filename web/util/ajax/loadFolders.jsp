...
<%
	...
	for(int n=0;n<subfolders.size();n++){
		...
		out.println("<tr><td><a href='javascript:setFolder(\""+nomenclature.getId()+"\")'><img style='vertical-align: middle' src='"+sCONTEXTPATH+"/_img/themes/default/menu_tee_plus.gif'/>"+(documents.size()>0?"<b>":"")+nomenclature.getId().toUpperCase()+": "+getTranNoLink("library",nomenclature.getId(),sWebLanguage)+" ["+documents.size()+"]"+(documents.size()>0?"</b>":"")+"</a></td></tr>");
	}
