  ...
  --%> 
    ...
    <table class="list" width='100%' cellpadding="1" cellspacing="1"> 
        ...
        <tr>
            ...
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultNumericInput(session, (TransactionVO)transaction, "ITEM_TYPE_CPN_PREGNANCYAGE", 3, 0,20,sWebLanguage) %>SA
            </td>
        ...
        <tr>
            ...
            <td class="admin2">
            	<%=ScreenHelper.writeDefaultNumericInput(session, (TransactionVO)transaction, "ITEM_TYPE_CPN_PB", 3, 0,20,sWebLanguage) %>Cm
            </td>
		...
		<tr>
         	...
         	<td class='admin2' colspan='1'>
                 <%=ScreenHelper.writeDefaultNumericInput(session, (TransactionVO)transaction, "ITEM_TYPE_CPN_FER", 3, 0,20,sWebLanguage) %>
             </td>
