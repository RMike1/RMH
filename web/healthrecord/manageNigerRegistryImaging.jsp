...
<form name="transactionForm" id="transactionForm" method="POST" action='<c:url value="/healthrecord/updateTransaction.do"/>?ts=<%=getTs()%>'>
    ...
    <table class="list" width="100%" cellspacing="1" cellpadding='0'>
		...
		<tr>
			...
			<td class='admin2' ><%=SH.writeDefaultSelect(request, tran, "!ITEM_TYPE_REQUESTINGSERVICE", "niger.imagingservice", sWebLanguage, "") %></td>
			<td class='admin'><%=getTran(request,"web","requestingimagerie",sWebLanguage) %></td>
			<td class='admin2' ><%=SH.writeDefaultSelect(request, tran, "!ITEM_TYPE_IMAGERIE", "niger.imagings", sWebLanguage, "") %></td>
